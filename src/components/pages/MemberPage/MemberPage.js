                    ...
                    <div className="container">
                        <div className="team-member__block">
                            <div className="row m-row align-middle">
                                <div className="column col-lg-7 team-member__image-column">
                                    <div className="team-member__image">
                                        ...
                                        <span className="team-member__role">{teamMember.role}</span>
                                    </div>
                                </div>
                                <div className="column col-lg-5 team-member__title-column">
                        ...
                        <div className="team-member__block">
                            <div className="row m-row align-middle">
                                ...
                                <div className="column col-lg-5">
                                    <img src={teamMember.image_2} alt="" className="image"/>
                                </div>
                            </div>
                        </div>
